...
public class CanteenMain {
	...
	static WalletDAO daoooov = new WalletDAO();

	
	public static void searchCustomer1() {
		int customerid;
		System.out.println("Enter customer Id  ");
		customerid = sc.nextInt();
		Wallet wallet = null;
		try {
			wallet = daoooov.searchCustomer1(customerid);
	...
	public static void searchWallet() {
		...
		Wallet wallet = null;
		try {
			wallet = daoooov.searchWallet(walletid);
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SQLException e) {
	...
	public static void main(String[] args) throws ParseException {
		...
		do {
		    ...
		    System.out.println("10. search customer through wallet");
